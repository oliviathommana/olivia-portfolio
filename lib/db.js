...
const seedActivities = [
  ...
  },
  {
    id: '5',
    date: '2026-06-15',
    title: 'CredifAI Model Optimization',
    description: 'Refined the NLP classifier for real-time fake news detection on political articles.',
    status: 'completed'
  },
  {
    id: '6',
    date: '2026-06-10',
    title: 'IoT Interfacing Study',
    description: 'Configured MQTT communication protocols on ESP32 microcontrollers for IIIT Kottayam course.',
    status: 'completed'
  },
  {
    id: '7',
    date: '2026-06-05',
    title: 'Trash2Cash Recommendation Engine',
    description: 'Implemented waste classification logic and reward calculation routines using MongoDB.',
    status: 'completed'
  },
  {
    id: '8',
